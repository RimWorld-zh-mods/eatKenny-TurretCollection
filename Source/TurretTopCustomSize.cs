...
namespace TurretCollection
{
    public class TurretTopCustomSize
    {
        ...
        public TurretTopCustomSize(Building_Turret ParentTurret)
        {
        ...
        public void DrawTurretXL(Vector3 topSize)
        {
            Matrix4x4 matrix4x = default(Matrix4x4);
            matrix4x.SetTRS(this.parentTurret.DrawPos + Altitudes.AltIncVect, this.CurRotation.ToQuat(), topSize);
